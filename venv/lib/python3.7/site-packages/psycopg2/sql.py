...
class SQL(Composable):
    ...
    `!SQL` exposes `join()` and `format()` methods useful to create a templates
    ...
    def format(self, *args, **kwargs):
        """
        Merge `Composable` objects into a templates.
        ...
        templates supports auto-numbered (``{}``, only available from Python
        ...
        `!Composable` objects can be passed to the templates.
